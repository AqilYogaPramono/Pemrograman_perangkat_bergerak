...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    setState(() {
      ...
      _counter++;
      //menampilkan nilai 1-10 jika sudah mencapai 10 maka nilainya akan kembali ke 1
      // if (_counter > 10) {
      //   _counter = 1;
      // }
